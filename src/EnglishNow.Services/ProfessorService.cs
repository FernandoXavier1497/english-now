...
namespace EnglishNow.Services
{
    ...
    public class ProfessorService: IProfessorService
    {
        ...
        public EditarProfessorResult Editar(EditarProfessorRequest request)
        {
            ...
            if (affectedRows == 0)
            {
                result.MensagemErro = "Não foi possivel atualizar o professor";
                return result;
            }
            ...
            if (affectedRows == 0)
            {
                result.MensagemErro = "Não foi possivel atualizar o usuário";
                return result;
            }
        ...
        public ExcluirProfessorResult Excluir(int id)
        {
            ...
            if (affectedRows == 0)
            {
                ...
                result.MensagemErro = "Não foi possivel exluir o professor";
            ...
            if (affectedRows == 0)
            {
                result.MensagemErro = "Não foi possivel exluir o usuário";
